 ...
 * Slug: avatarnews/template-sitemap
 * Categories: template
 * Inserter: false
 */
?>
<!-- wp:template-part {"slug":"header","theme":"avatarnews","area":"header"} /-->
    ...
    <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns -->
        <div class="wp-block-columns"><!-- wp:column -->
            <div class="wp-block-column"><!-- wp:heading {"level":4} -->
                <h4 class="wp-block-heading"><?php esc_html_e('Pages', 'avatarnews') ?></h4>
                <!-- /wp:heading -->

                <!-- wp:page-list {"className":"is-style-avatarnews-page-list-bullet-hide-style","style":{"typography":{"lineHeight":"2"}}} /-->
            </div>
            <!-- /wp:column -->

            <!-- wp:column -->
            <div class="wp-block-column"><!-- wp:heading {"level":4} -->
                <h4 class="wp-block-heading"><?php esc_html_e('Categories', 'avatarnews') ?></h4>
                <!-- /wp:heading -->

                <!-- wp:categories {"showHierarchy":true,"showPostCounts":true,"className":"is-style-avatarnews-categories-bullet-hide-style","style":{"typography":{"lineHeight":"2"}}} /-->
            </div>
            <!-- /wp:column -->

            <!-- wp:column -->
            <div class="wp-block-column"><!-- wp:heading {"level":4} -->
                <h4 class="wp-block-heading"><?php esc_html_e('Posts', 'avatarnews') ?></h4>
                <!-- /wp:heading -->
...
<!-- wp:template-part {"slug":"footer","theme":"avatarnews","area":"footer"} /-->